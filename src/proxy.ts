...
// Server-side proxy cannot read Firebase Auth state directly.
// Route protection is handled client-side by AuthGuard.tsx.
// This proxy only handles public asset/API routing.

export function proxy(request: NextRequest) {
  // No server-side auth check here — Firebase tokens are not accessible in proxy.
